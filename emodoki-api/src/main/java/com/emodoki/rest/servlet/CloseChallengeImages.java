...
/**
 * Servlet implementation class CloseChallengeImages
 */
@WebServlet("/closechallengeimages")
public class CloseChallengeImages extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (code != null && !code.equals("")) {
				...
				String path = realPath + "/closechallengeimagesdir/"+code;
