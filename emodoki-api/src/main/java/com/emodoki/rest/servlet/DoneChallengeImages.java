...
/**
 * Servlet implementation class DoneCallengeImages
 */
@WebServlet("/donechallengeimages")
public class DoneChallengeImages extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoneChallengeImages() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (code != null && !code.equals("")) {
				...
				String path = realPath + "/donechallengeimagesdir/"+code;
